...
filename = 'spin_glass_switch_fields_min_model_cont_2018_07_05_4_48/min_model_';
...
for iter_4 = 1:10
    stat_means_i{iter_4} = zeros(1, numel(0:100:t_max) - 1);
    stat_means_f{iter_4} = zeros(1, numel(0:100:t_max) - 1);
    stat_means_2_i{iter_4} = zeros(1, numel(0:100:t_max) - 1);
...
% % %             
            ...
            other_drive = [];
            t = 1;
            all_fields = 1:(number_fields(iter_5) * 2);
