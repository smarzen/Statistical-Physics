...
folder_name = strcat('spin_glass_switch_fields_string_order_drive_quarter_per_rand_corr_', string(date));
...
%         final_spins = [final_spins, spin_glass_function_switch_driving_fields_fast(initial_spin_list(:, iter_2), interactions, spin_barriers, 0, 10, zeros(num_spins, 1), 100, true, 0, 100000, strcat(folder_name, '/', file))];
        final_spins = [final_spins, spin_glass_function_switch_driving_fields_calc_corr(initial_spin_list(:, iter_2), logical(zeros(num_spins, 1)), interactions, spin_barriers, 0, 10, zeros(num_spins, 1), 100, ones(1, 10000), 0, 100000, strcat(folder_name, '/', file))];
    end
end
...
%             final_spins_fixed = spin_glass_function_switch_driving_fields_fix_spins(final_spins(:, 1), logical(zeros(num_spins, 1)), interactions, spin_barriers, 0, 10, driving_fields_2, 20000, random_order, 0, 100000, strcat(folder_name, '/', file_5));
            ...
            final_spins_same = spin_glass_function_switch_driving_fields_calc_corr(final_spins(:, 1), logical(zeros(num_spins, 1)), interactions, spin_barriers, 0, 10, driving_fields, 100, random_order, 0, 90000, strcat(folder_name, '/', file));
...
%             final_spins_same = spin_glass_function_switch_driving_fields_fix_spins_2(final_spins_same, logical(zeros(num_spins, 1)), interactions, spin_barriers, 0, 10, driving_fields_2, 100, random_order, 0, 10000, strcat(folder_name, '/', file_3));
            ...
            final_spins_same = spin_glass_function_switch_driving_fields_calc_corr(final_spins(:, 1), logical(zeros(num_spins, 1)), interactions, spin_barriers, 0, 10, driving_fields, 100, periodic_order, 0, 90000, strcat(folder_name, '/', file_2));
