...
xlabel('field switches', 'FontSize', 40, 'FontName', 'Helvetica Neue')
ylabel('flips/switch', 'FontSize', 40, 'FontName', 'Helvetica Neue', 'Color', 'b')
title('heated low flip rate average', 'FontSize', 40, 'FontName', 'Helvetica Neue')
axis([0, 300, 0, .018])
...
ylabel('E_{int}', 'FontSize', 40, 'FontName', 'Helvetica Neue', 'Color', 'r')
axis([0, 300, -4.2, -2.8])
ticklabels = get(gca, 'YTickLabel');
ticklabels_new = cell(size(ticklabels));
for i = 1:length(ticklabels)
