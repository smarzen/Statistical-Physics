function final_spins = spin_glass_function_generate_driving_fields_fast(spins, interactions, spin_barriers, external_field, beta, driving_field_mag, switch_time, is_periodic, driving_strength, t_max, file_name)
...
driving_field(fast_spins) = normrnd(0, driving_field_mag, [numel(fast_spins), 1]);
...
total_heat_lost = 0;
internal_work = 0;
statistics = [t; energy; internal_energy; mean_mag; total_work; total_heat_lost; internal_work];
spin_hist = spins;
