function final_spins = spin_glass_function_generate_driving_fields_fast_2(spins, interactions, spin_barriers, external_field, beta, driving_field_mag, switch_time, deterministic_fields, p_deterministic, driving_strength, t_max, file_name)
