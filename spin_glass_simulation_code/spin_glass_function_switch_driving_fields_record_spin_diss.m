function final_spins = spin_glass_function_switch_driving_fields_record_spin_diss(spins, interactions, spin_barriers, external_field, beta, driving_fields, switch_time, random_order, driving_strength, t_max, file_name)
