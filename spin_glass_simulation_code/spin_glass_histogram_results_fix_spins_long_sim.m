...
filename = 'spin_glass_switch_fields_fix_slow_many_realizations_2018_01_18_12_00/unfixed_slow_';
...
%             
            interp_stats = diff(interp1(stats(1, t_index), sum(spin_diss(1:32, t_index), 1), 0:100:t_max));
...
filename = 'spin_glass_switch_fields_fix_slow_many_realizations_2018_01_18_12_00/fixed_slow_';
% instrinsic flip rates, two drives
...
figure(10)
hold off
scatter(all_means_f, all_means_f_2 - all_means_2_f, 'Filled')
hold on

fit = polyfit(all_means_f, all_means_f_2 - all_means_2_f, 1);
plot(linspace(0, 4), polyval(fit, linspace(0, 4)), 'LineWidth', 2);
axis([-5, 5, -5, 5])

% figure(11)
% scatter(all_means_f, all_means_2_i, 'Filled')
% 
% figure(12)
