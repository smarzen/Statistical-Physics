...
xlabel('field switches', 'FontSize', 20, 'Interpreter', 'LaTeX')
ylabel('flips/switch', 'FontSize', 20, 'Interpreter', 'LaTeX', 'Color', 'b')
title('driven high flip rate average', 'FontSize', 20, 'Interpreter', 'LaTeX')
axis([0, 300, 0, .26])
...
ylabel('local energy', 'FontSize', 20, 'Interpreter', 'LaTeX', 'Color', 'r')
axis([0, 300, -1.4, 1.8])
ticklabels = get(gca, 'YTickLabel');
ticklabels_new = cell(size(ticklabels));
for i = 1:length(ticklabels)
