...
%             [early_counts, sort_order] = sort(early_counts);
%             late_counts = late_counts(sort_order);

            [late_counts, sort_order] = sort(late_counts);
            early_counts = early_counts(sort_order);
...
title('driven spin flip rate distribution', 'FontSize', 20)
