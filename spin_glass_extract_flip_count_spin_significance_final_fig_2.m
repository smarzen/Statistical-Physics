...
figure()
plot(mean_early_counts / 5, 'b', 'LineWidth', 2)
hold on
plot(mean_late_counts / 5, 'r', 'LineWidth', 2)
xlabel('flip rate spin rank', 'FontName', 'Helvetica Neue', 'FontSize', 20)
ylabel('flips/switch', 'FontName', 'Helvetica Neue', 'FontSize', 20)
...
figure()
plot(mean_neighbor_flips_i, 'b', 'LineWidth', 2)
hold on
plot(mean_neighbor_flips_f, 'r', 'LineWidth', 2)
xlabel('flip rate spin rank', 'FontSize', 20)
ylabel('mean neighbor flips', 'FontSize', 20)
legend({'initial', 'final'}, 'FontSize', 20)
axis([1, 256, .8E4, 2.2E4])
...
histogram(flip_rate_differences(157, :) * 100, -10:.25:10, 'FaceColor', 'b', 'Normalization', 'probability')
hold on
...
legend({'slow spin (rank 100)', 'fast spin (rank 1)'}, 'FontSize', 16, 'FontName', 'Helvetica Neue')
