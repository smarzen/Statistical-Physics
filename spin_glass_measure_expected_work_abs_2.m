...
filename = 'spin_glass_switch_fields_drive_quarter_reverse_field_order_2019_02_07_4_39/random_order_';
...
%                     hist_2 = [hist_2, spin_hist];
            ...
            for iter_7 = 1:590
                ...
                if transitions(current_field, current_field)
                    ...
                    other_abs = [other_abs, other_energy / sum(1 - transitions(random_order(iter_7), 1:10))];
